...
def get_learner_fn(
    ...
    def _update_step(learner_state: EwmaLearnerState, _: Any) -> Tuple[EwmaLearnerState, Tuple]:
        ...
        def _env_step(learner_state: EwmaLearnerState, _: Any) -> Tuple[EwmaLearnerState, PPOTransition]:
            ...
            learner_state = EwmaLearnerState(params, opt_states, rng, env_state, timestep)
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                ewma_new_params = jax.tree_util.tree_map(
                    lambda p, e: p / new_weight + e * ewma_decay * params.total_weight / new_weight, 
                    params.actor_params, 
                    params.ewma_params,
                )
        ...
        params, opt_states, traj_batch, advantages, targets, rng = update_state
        learner_state = EwmaLearnerState(params, opt_states, rng, env_state, last_timestep)
        metric = traj_batch.info
        return learner_state, (metric, loss_info)

    def learner_fn(learner_state: EwmaLearnerState) -> ExperimentOutput[EwmaLearnerState]:
        """Learner function.
...
def learner_setup(
...
) -> Tuple[LearnerFn[EwmaLearnerState], Actor, EwmaLearnerState]:
    ...
    # total_weight = jnp.broadcast_to(total_weight, (n_devices, config["system"]["update_batch_size"]) + total_weight.shape) #TODO: check this, possible error.
